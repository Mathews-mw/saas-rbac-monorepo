import { getBilling } from '@/_http/requests/get-billing';
					...
					<Table>
						...
						<TableBody>
							...
							<TableRow>
								...
								<TableCell className="text-right">
									{billing.seats.price.toLocaleString('en-US', { style: 'currency', currency: 'USD' })} (
									{billing.seats.unit.toLocaleString('en-US', { style: 'currency', currency: 'USD' })} each)
								</TableCell>
							</TableRow>
						</TableBody>
